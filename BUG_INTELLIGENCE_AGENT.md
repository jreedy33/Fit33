...
| `bug_intel_classify_error(pg, http, nsurl, msg)` | `20260516` (+ `20260714` rewrite with regex extractor) | Error taxonomy — used by rollup + admin |
