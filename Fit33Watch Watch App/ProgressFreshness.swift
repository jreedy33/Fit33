// ProgressFreshness.swift (watch mirror)
// Realtime Widget Server Pull, Phase 8f (2026-04-26)
//
// IMPORTANT: this is a byte-for-byte mirror of
// `Fit33/ProgressFreshness.swift` and
// `RunningActivityWidget/ProgressFreshness.swift`.
// The watch extension can't easily share files with the main `Fit33`
// target (no cross-target module), so we duplicate the small pure-
// Foundation utility. If you edit one file, edit all three.
// Duplicate justification per PE invariant 30.
