...
26. **DELETED dead-code list (do NOT re-introduce — 2026-05-03 perf sprint).** The following symbols/types existed historically as scaffolding but had ZERO call sites elsewhere in the app and were removed in the cold-start sprint. If you find yourself wanting one of these, the canonical replacement is listed:
