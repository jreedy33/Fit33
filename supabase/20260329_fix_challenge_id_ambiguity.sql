-- ============================================================================
-- Migration: Fix challenge_id column ambiguity in private challenge RPCs
-- Date: 2026-03-29
-- Purpose: RETURNS TABLE (challenge_id UUID, ...) creates a PL/pgSQL variable
--          that conflicts with challenge_id columns on joined tables. Adding
--          #variable_conflict use_column tells Postgres to resolve in favor of
--          table columns, which is correct since the function uses v_challenge_id
--          for its own variable references.
-- Fixes: 8 crashes — "column reference 'challenge_id' is ambiguous" (v1.37)
-- ============================================================================

-- 1. get_private_challenge_detail
