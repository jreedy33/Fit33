-- =====================================================
-- STEP 2: Create the new function with today_progress fields
-- =====================================================
-- Run this AFTER successfully running FIX_CHALLENGE_TODAYS_PROGRESS.sql
-- =====================================================
...
RETURNS TABLE (
    ...
    my_today_progress INTEGER,  -- NEW: Today's progress only
    ...
    opponent_today_progress INTEGER,  -- NEW: Opponent's today progress
    opponent_days_completed INTEGER,
    am_winning BOOLEAN,
    am_winning_today BOOLEAN  -- NEW: Who's winning today specifically
) AS $$
DECLARE
...
SELECT '✅ Challenge function recreated with today_progress fields!' as result;
